...
function buildPayload(commitOid, ref, analysisKey, analysisName, zippedSarif, workflowRunID, checkoutURI, environment, toolNames, gitHubVersion, baseCommitOid) {
    if (util.isActions()) {
        const payloadObj = {
        ...
        if (gitHubVersion.type !== util.GitHubVariant.GHES ||
            ...
            if (process.env.GITHUB_EVENT_NAME === "pull_request" &&
                ...
                payloadObj.base_sha = baseCommitOid !== null && baseCommitOid !== void 0 ? baseCommitOid : githubEvent.pull_request.base.sha;
            }
        }
        return payloadObj;
    }
